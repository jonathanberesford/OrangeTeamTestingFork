...
public class Taxes {
    ...
    static String printBracket(double t, String bracket){
        return "You are in the " + bracket + " tax bracket.\n" +
                "You will be paying £" + makePretty(t) + " in tax. Here's the breakdown:\n";
    }
    static String output(float income){
        if (income < 15000) {
            return "You are in the 0% tax bracket.\nYou earn all your money tax free!";
        } else {
            ...
            if (income < 20000) {
                ...
                return printBracket(tax, "10%") +
                        "You earn the first £15000 tax free.\n" +
                        "This leaves £" +
                        makePretty(income - 15000) + ", of which you pay 10%, or £" +
                        makePretty(tax) + " in tax";
            } else if (income < 30000) {
                tax = ((income - 20000) * 0.15) + 500;
                return printBracket(tax, "15%") +
                        "You earn the first £15000 tax free.\n" +
                        "You pay 10% on your next £5000, which is £500\n" +
                        "This leaves £" + makePretty(income - 20000) +
                        ", of which you pay 15%, or £" +
                        makePretty(tax - 500) + " in tax";
            } else if (income < 45000) {
                tax = ((income - 30000) * 0.2) + 2000;
                return printBracket(tax, "20%") +
                        "You earn the first £15000 tax free.\n" +
                        "You pay 10% on your next £5000, which is £500\n" +
                        "You pay 15% on your next £10000, which is £1500\n" +
                        "This leaves £" + makePretty(income - 30000) +
                        ", of which you pay 20%, or £" +
                        makePretty(tax - 2000) + " in tax";
            } else {
                tax = ((income - 45000) * 0.25) + 5000;
                return printBracket(tax, "25%") +
                        "You earn the first £15000 tax free.\n" +
                        "You pay 10% on your next £5000, which is £500\n" +
                        "You pay 15% on your next £10000, which is £1500\n" +
                        "You pay 20% on your next £15000, which is £3000\n" +
                        "This leaves £" + makePretty(income - 45000) +
                        ", of which you pay 25%, or £" +
    ...
    public static void main(String[] args) {
        ...
        System.out.println(output(income));
    }
}
/*
0      - 14,999 :  0pc
